...
deepspeed --include localhost:0,1 ../../finetune_show.py \
    ...
    --model_name_or_path ../../result_model/stage1/[v3.CC3M-Pretrain-595K]qwen2.5_3B_Instruct_clipvL14/checkpoint-46000 \
    ...
    --output_dir ../../result_model/stage2/scienceqa/[v2.finetune_sqa]/trainjson_ck46000_qwen2.5_3B_Instruct_clipvL14 \
    --num_train_epochs 3 \
    ...
    --learning_rate 2e-4 \
    --logging_steps 8 \
    --logging_dir "../../train_log/stage2/[v2.finetune_sqa]trainjson_ck46000_qwen2.5_3B_Instruct_clipvL14"
